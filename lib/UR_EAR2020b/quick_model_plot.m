function quick_model_plot(filename, CF_plot)
% Script to plot some model responses from the population; 
%insert filename that you used to save the data from UR_EAR GUI
% and the CF that you want to plot (the closest CF in yrou model population
% will be plotted).
