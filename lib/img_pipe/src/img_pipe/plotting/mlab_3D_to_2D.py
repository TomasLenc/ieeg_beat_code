...
def _project_3d_to_2d(plotter, xyz):
    """Calculate 2D coordinated of the set of 3D points in a rendered pyvista figure.
    ...
    ----------
        ...
        xyz : array_like
            [N x 3] array of coordinates in the 3D plotter space.

    Returns
    -------
        xy: array_like
            [N x 2] array of coordinates in the 2D projected view space.
    """
