def get_lut(atlas='desikan-killiany'):
    ''' Get colors from the freesurfer lookup table.

    Parameters
    ----------
    atlas : str
        Name of the lookup table (e.g. 'FS' for freesurfer, or 'Chang' for Hamilton2021)
    ...
    if (atlas == 'chang') or (atlas == 'merged') or (atlas == 'custom'): 
        ...
        cmap = {
            ...
            'pSTG': [176, 30, 35],
            'mSTG': [177, 178, 53],
            'inferiorfrontal': [25, 159, 181],
            'IFG': [25, 159, 181],
            'middlefrontal': [101, 78, 163],
            'MFG': [101, 78, 163],
            'sensorymotor': [130, 90, 44], 
            'SMC': [130, 90, 44], 
            'supramarginal': [230, 126, 34],
            'SMG': [230, 126, 34],
            'SFG': [20, 220, 160],
            'SMA': [230, 106, 145],
            'preSMA': [232, 137, 199],
